...
console.log(searchRotatedArray([1, 3, 5], 5)); // Output: 2
console.log(searchRotatedArray([5, 1, 3], 3)); // Output: 2
console.log(searchRotatedArray([4, 5, 6, 7, 0, 1, 2], 5)); // Output: 1
console.log(searchRotatedArray([4, 5, 6, 7, 0, 1, 2], 2)); // Output: 6
console.log(searchRotatedArray([1, 3], 3)); // Output: 1
console.log(searchRotatedArray([3, 5, 1], 5)); // Output: 1
console.log(searchRotatedArray([2, 5, 6, 0, 0, 1, 2], 0)); // Output: 3 or 4 (depends on the implementation)
